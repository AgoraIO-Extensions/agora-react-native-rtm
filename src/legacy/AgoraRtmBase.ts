 ...
 * Rtm link operation.
 */
export enum RTM_LINK_OPERATION {
  /**
   * Login.
   */
...
export class RtmPrivateConfig {
   ...
   * Rtm service type.
   */
  serviceType?: RTM_SERVICE_TYPE = RTM_SERVICE_TYPE.RTM_SERVICE_TYPE_NONE;
  /**
